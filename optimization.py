...
def main():
    ...
    print("generate random solution")
    ...
    while not got_max_sol and max_iterations != 10:
        iter += 1
        print("start iteration ", iter)
        print(f'Best score so far: {best_score} solution: {solution}\n')
...
def process(solution, width, length, hot_zones):
    print("crate new room")
    room_init = set_room(width, length)
    print("install all cameras..")
